package com.macmoholic.autoranker.command;
...
public class InfoCommands {
	...
	public static void Info(Player player, String[] args) {
		...
		// need to build a check to see if player exists
		// probably want to use a data stream to save rank and name
		// input all into a file, see what that mess looks like, but also save the order
